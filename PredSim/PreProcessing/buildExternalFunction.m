...
% test if foo.py exists
if ~exist(path_external_filename_foo,'file');
    error(['error in creating the foo.py file, this means most likley that you have, ...' ...
        'an error in the cpp file. Run the code with verbose = 1 and analyse the cmake output ']);
end
