...
R.metabolics.Marg.Power = getMetabolicEnergy_MargariaSmooth(R.muscles.Fce,R.muscles.vM,1000);
NetPower = sum(R.metabolics.Marg.Power,2);
Work = trapz(R.time.mesh_GC(1:end-1),NetPower);
R.metabolics.Marg.COT = Work/R.misc.body_mass/R.spatiotemp.dist_trav;
